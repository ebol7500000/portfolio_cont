		...
		<div id="side1-PC">
			...
			<div id="box-link-5-PC">
				...
				<div id="box-texto-10-PC">
					<img id="img-2-PC" src="../img_geral/main_inv_23_3_text.svg"/>	
				</div>	
			</div>

			<a href="../em-a-asc-ii-OR/index.php">
				<div id="box-1">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/mini_sys_dpa.png"/>	
					</div>

					<div id="icon-img">
						<img id="img-PC" src="../img_geral/ppor.png"/>
					</div>

					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/mini_sys_dpa_text.png"/>
					</div>

				</div>
			</a>
			
			<a href="../em-a-asc-ii-RES/index.php">
				<div id="box-2">
					<div id="title-img">
						<img id="img-PC" src="../img_geral/ppe.png"/>	
					</div>
					...
					<div id="about-img">
						<img id="img-2-PC" src="../img_geral/resultado.png"/>
					</div>
